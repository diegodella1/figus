  ...
  "focus-ring sticker-edge inline-flex h-10 items-center justify-center gap-2 border px-4 py-2 text-sm font-black uppercase transition disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        secondary: "border-border bg-white text-card-foreground hover:border-primary/40 hover:bg-muted/80",
        outline: "border-border bg-transparent hover:border-primary/50 hover:bg-primary/10",
